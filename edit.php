...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <div class="dropdown-menu" aria-labelledby="contactDropdown">
        <a class="dropdown-item" href="https://www.instagram.com/kaka_rhyo/">Instagram</a>
        <a class="dropdown-item" href="https://wa.me/621344823021">WhatsApp</a>
        <a class="dropdown-item" href="https://www.tiktok.com/@putrix_1?is_from_webapp=1&sender_device=pc">TikTok</a>
    </div>
</li>
    </ul>
    ...
    <div class="content-header">
      ...
      <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit dengan lengkap!</h3>
              </div>
              <!-- /.card-header -->
            ...
            <?php
                include('koneksi.php');
                $nim = $_GET['nim'];
                $data = mysqli_query($kon,"select * from anggota where nim = '$nim'");
