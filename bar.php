  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Diagram Batang</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
             ...
             <div class="card card-success">
              ...
              include("koneksi.php");
                ...
                $query = "SELECT jenis_kelamin, COUNT(*) as jumlah FROM anggota GROUP BY jenis_kelamin";
...
var myBarChart = new Chart(ctx1, {
    ...
    options: {
        indexAxis: 'x', // Mengubah indexAxis menjadi 'x'
        elements: {
            bar: {
                borderWidth: 1,
                borderRadius: 4,
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Grafik Jumlah Mahasiswa per Jenis Kelamin',
            }
        },
        scales: {
            y: { // Mengubah menjadi 'y' karena indexAxis telah diubah menjadi 'x'
                beginAtZero: true
            }
        }
    }
