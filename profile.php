...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] && $_SESSION['loggedin'] !== true) {
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo $_SESSION['admin_name']; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $_SESSION['admin_email']; ?></h3>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  Information System in Cenderawasih University
                </p>
                ...
                <p class="text-muted">Jayapura, Papua</p>
                ...
                <p class="text-muted">
                  ...
                  <span class="tag tag-warning">Photoshop, </span>
                  <span class="tag tag-warning">Adobe illustrator, </span>
                  <span class="tag tag-warning">Adobe animate</span>
                </p>
                ...
                <p class="text-muted">Ora et La Bora</p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Catatan</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputName" value="<?php echo $_SESSION['admin_name']; ?>" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputEmail" value="<?php echo $_SESSION['admin_email']; ?>" disabled>
                        </div>
                      </div>
                    </form>
                      </div>
