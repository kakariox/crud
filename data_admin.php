        ...
        while ($data = mysqli_fetch_array($hasil)) {
            ...
            <tr>
                ...
                <td><div class="centered">
                    <a href="editadmin.php?id=<?php echo htmlspecialchars($data['id']); ?>" class="btn btn-warning" role="button">Edit</a>
                    <a href="hapusadmin.php?id=<?php echo $data['id']; ?>" class="btn btn-danger" role="button">Hapus</a>          
                  </tr>
            <?php
        }
        ?>
